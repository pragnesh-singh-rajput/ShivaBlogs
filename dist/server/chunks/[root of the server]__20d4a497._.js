...
"[project]/.next-internal/server/app/api/subscribe/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
const subscribeSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].object({
...
async function POST(request) {
    ...
    try {
        ...
        if (!validation.success) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: validation.error.format().email?._errors.join(', ') || "Invalid input."
            }, {
                status: 400
            });
        }
        ...
        try {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'An unexpected error occurred with the subscription service.'
            }, {
                status: 500
            });
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__20d4a497._.js.map